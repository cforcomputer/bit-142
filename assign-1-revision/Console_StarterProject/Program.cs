...
namespace QuizProgram
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int answer = 0; // holds the answer to A % B (or A + B, etc)
            int usersAnswer = 0; // holds the user's answer to A % B (or A + B, etc)
            ...
            for (int iQuiz = 0; iQuiz < numTimesToQuiz; iQuiz++)
            {
                ...
                /// 
                /// #3
                /// this time using at least one switch statement
